                ...
                for item in graph_data:
                    ...
                    for key in model.fields:
                        ...
                        if isinstance(item.data[key], list):
                            ...
                            for item_data_key in item.data[key]:
                                # create new node_pk
                                if i == 0:
                                    node_pk_list = [node_pk + '__' + item_data_key for node_pk in node_pk_list_prev]
                                else:
                                    for item2 in [node_pk + '__' + item_data_key for node_pk in node_pk_list_prev]:
                    ...
                    for node_pk in node_pk_list:
                        if node_pk not in arr_node_pk:
                            ...
                            copied_item['label'] = node_pk  # label
